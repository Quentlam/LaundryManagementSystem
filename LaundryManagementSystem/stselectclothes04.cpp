...
#include "ui_stselectclothes04.h"

STSelectClothes04::STSelectClothes04(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::STSelectClothes04)
{
    ui->setupUi(this);
...
STSelectClothes04::~STSelectClothes04()
{
    delete ui;
}

void STSelectClothes04::keyPressEvent(QKeyEvent* event)
{
...
void STSelectClothes04::lineFocus()
{
    ui->lineEdit->setFocus();
}

void STSelectClothes04::on_tableWidget_cellClicked(int row, int column)
{
    message = ui->tableWidget->item(row,1)->text();
...
void STSelectClothes04::on_lineEdit_textChanged(const QString &arg1)
{
    for (int row = 0; row < ui->tableWidget->rowCount(); ++row)
    {
        bool rowMatches = false;
